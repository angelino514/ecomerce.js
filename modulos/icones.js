export function homeLockIcon() {
   return `
   <svg class="icon icnes_navbar" viewBox="0 0 24 24" fill="none">
...
export function deleteIcon() {
   return `
   <svg class="icon deleteIcon" viewBox="0 0 24 24" width="24" height="24" fill="none">
